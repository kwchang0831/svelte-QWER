...
{#if loaded}
  {#key $postsShow}
    <footer
      ...
      <main
        class="op70 my4 gap1 md:(border-t-2 w-3xl mt-8 border-black border-opacity-20 dark:(border-white border-opacity-10)) flex flex-col justify-center items-center">
        <div class="hidden">
