    ...
    <footer
      ...
      <main class="rounded-b-2xl pb6 my4 gap1 flex flex-col justify-center items-center md:(border-t-2 w-3xl mt-8)">
        ...
        <div class="flex justify-center mt-4">
          <a use:tippy href="/atom.xml" class="btn btn-ghost" aria-label="Atom Feed" data-sveltekit-prefetch="off">
            <div class="!w-[1.75rem] !h-[1.75rem] i-ic-baseline-rss-feed" />
          </a>
          <a use:tippy href="/sitemap.xml" class="btn btn-ghost" aria-label="Sitemap" data-sveltekit-prefetch="off">
